...
region_to_endpoint = {
    ...
    'ap-northeast-1' : Endpoint('Asia Pacific (Osaka-Local)', 's3-website.ap-northeast-3.amazonaws.com', 'Z2YQB5RD63NC85'),
...
def known_region(region):
    """Returns True if this is known region."""
    return region in region_to_endpoint

def get_endpoint(region):
    """Returns the s3 website endpoint for the provided region."""
